"""
Django settings for wagtailresdigitacom project.
...
INSTALLED_APPS = [
    "wagtailresdigitacom.forms",
    "wagtailresdigitacom.home",
    "wagtailresdigitacom.images",
    "wagtailresdigitacom.navigation",
    "wagtailresdigitacom.news",
    "wagtailresdigitacom.search",
    "wagtailresdigitacom.standardpages",
    "wagtailresdigitacom.users",
    "wagtailresdigitacom.utils",
...
WAGTAIL_SITE_NAME = "wagtailresdigitacom"
