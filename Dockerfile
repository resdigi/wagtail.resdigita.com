...
ENV PATH=$VIRTUAL_ENV/bin:$PATH \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=wagtailresdigitacom.settings.production \
    PORT=8000
...
CMD set -xe; python manage.py createcachetable; python manage.py migrate --noinput; gunicorn wagtailresdigitacom.wsgi:application
